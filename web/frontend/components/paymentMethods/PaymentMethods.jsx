...
export function PaymentMethods(props) {
  ...
  const savePaymentMethod = async () => {
    await fetch("/api/carrier-service/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
  ...
  const addPaymentMethod = () => {
    try {
      ...
      if (isValid) {
        ...
        axios
          .post(
            `${process.env.API_ENDPOINT}/api/wp/savePaymentMethod`,
            payload,
            { headers: headers }
          )
          .then((response) => {
  ...
  const getPaymentMethods = () => {
    ...
    axios
      .get(`${process.env.API_ENDPOINT}/api/wp/payment_method`, {
        headers: headers,
      })
      .then((response) => {
        setPaymentMethods(response.data.data);
                ...
                <div className="payment-item-left">
                  <div className="input-radio">
                    <input
                      ...
                      checked={selectedMethod == method.card_id}
                    />
                  </div>
                  {method.brand == "visa" && (
