...
function Extension() {
  ...
  getOrderDetails = async () => {
    ...
    const result = await fetch(
      `https://lauren-treasure-lauderdale-valium.trycloudflare.com/api/get-order/${orderId}`,
      {
        method: "GET",
        headers: {
    ...
    if (codes != null) {
      ...
      const setMetafields = await fetch(
        `https://lauren-treasure-lauderdale-valium.trycloudflare.com/api/set-order-metafields`,
        {
          method: "POST",
          headers: {
            "Access-Control-Allow-Origin": "*",
      ...
      const result = await fetch(
        `https://lauren-treasure-lauderdale-valium.trycloudflare.com/api/process-order/${orderId}`,
        {
          method: "GET",
          headers: {
            "Access-Control-Allow-Origin": "*",
